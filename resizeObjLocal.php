...
$originalSingleModelWidth = 3; //paper cut size in model in cm
...
parseAndSave(1, $width + 1, $originalSingleModelWidth, "output-width.obj");
parseAndSave(1, $height + 1, $originalSingleModelWidth, "output-height.obj");